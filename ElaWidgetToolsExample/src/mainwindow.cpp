...
void MainWindow::initContent()
{
    ...
    _settingPage_1 = new CS_Setting(this);
    _settingPage_2 = new CS_Personal(this);
    _settingPage_3 = new CS_Screen(this);
...
//     navigation(elaScreenWidget->property("ElaPageKey").toString());
    addPageNode("基础设置", _settingPage_1, ElaIconType::CabinetFiling);
    addPageNode("个性设置", _settingPage_2, ElaIconType::Person);
    addPageNode("图像设置", _settingPage_3, ElaIconType::CameraViewfinder);
