...
#include <memory>
#include "../../../../../../element/ElaWidgetTools/include/ElaGraphicsView.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ElaGraphicsView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ElaGraphicsView_t qt_meta_stringdata_ElaGraphicsView = {
    {
QT_MOC_LITERAL(0, 0, 15), // "ElaGraphicsView"
...
void ElaGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElaGraphicsView::pMaxTransformChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ElaGraphicsView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElaGraphicsView::pMinTransformChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ElaGraphicsView::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsView::staticMetaObject>(),
    qt_meta_stringdata_ElaGraphicsView.data,
