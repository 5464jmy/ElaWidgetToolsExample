...
#include <memory>
#include "../../../../../../element/ElaWidgetTools/DeveloperComponents/ElaComboBoxStyle.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ElaComboBoxStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ElaComboBoxStyle_t qt_meta_stringdata_ElaComboBoxStyle = {
    {
QT_MOC_LITERAL(0, 0, 16), // "ElaComboBoxStyle"
QT_MOC_LITERAL(1, 17, 24), // "pExpandIconRotateChanged"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 23), // "pExpandMarkWidthChanged"
QT_MOC_LITERAL(4, 67, 17), // "pExpandIconRotate"
QT_MOC_LITERAL(5, 85, 16) // "pExpandMarkWidth"
...
void ElaComboBoxStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElaComboBoxStyle::pExpandIconRotateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ElaComboBoxStyle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElaComboBoxStyle::pExpandMarkWidthChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ElaComboBoxStyle::staticMetaObject = { {
    QMetaObject::SuperData::link<QProxyStyle::staticMetaObject>(),
    qt_meta_stringdata_ElaComboBoxStyle.data,
