...
#include <memory>
#include "../../../../../../element/ElaWidgetTools/DeveloperComponents/ElaTableViewStyle.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ElaTableViewStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ElaTableViewStyle_t qt_meta_stringdata_ElaTableViewStyle = {
    {
QT_MOC_LITERAL(0, 0, 17), // "ElaTableViewStyle"
QT_MOC_LITERAL(1, 18, 20), // "pHeaderMarginChanged"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 23), // "pCurrentHoverRowChanged"
QT_MOC_LITERAL(4, 64, 13), // "pHeaderMargin"
QT_MOC_LITERAL(5, 78, 16) // "pCurrentHoverRow"

    },
    "ElaTableViewStyle\0pHeaderMarginChanged\0"
    "\0pCurrentHoverRowChanged\0pHeaderMargin\0"
    "pCurrentHoverRow"
};
...
void ElaTableViewStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ElaTableViewStyle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElaTableViewStyle::pHeaderMarginChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ElaTableViewStyle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElaTableViewStyle::pCurrentHoverRowChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        case 0:
            ...
            break;
        case 1:
            if (_t->_pCurrentHoverRow != *reinterpret_cast< int*>(_v)) {
                _t->_pCurrentHoverRow = *reinterpret_cast< int*>(_v);
...
QT_INIT_METAOBJECT const QMetaObject ElaTableViewStyle::staticMetaObject = { {
    QMetaObject::SuperData::link<QProxyStyle::staticMetaObject>(),
    qt_meta_stringdata_ElaTableViewStyle.data,
