...
#include <memory>
#include "../../../../../../element/ElaWidgetTools/DeveloperComponents/ElaMenuStyle.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ElaMenuStyle_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ElaMenuStyle_t qt_meta_stringdata_ElaMenuStyle = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ElaMenuStyle"
QT_MOC_LITERAL(1, 13, 22), // "pMenuItemHeightChanged"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 15) // "pMenuItemHeight"
...
void ElaMenuStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ElaMenuStyle::pMenuItemHeightChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ElaMenuStyle::staticMetaObject = { {
    QMetaObject::SuperData::link<QProxyStyle::staticMetaObject>(),
    qt_meta_stringdata_ElaMenuStyle.data,
