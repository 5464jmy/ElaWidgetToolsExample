...
#include <memory>
#include "../../../ExamplePage/T_BasePage.h"
...
struct qt_meta_stringdata_T_BasePage_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_T_BasePage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_T_BasePage_t qt_meta_stringdata_T_BasePage = {
    {
QT_MOC_LITERAL(0, 0, 10) // "T_BasePage"
...
static const uint qt_meta_data_T_BasePage[] = {
...
QT_INIT_METAOBJECT const QMetaObject T_BasePage::staticMetaObject = { {
    QMetaObject::SuperData::link<ElaScrollPage::staticMetaObject>(),
    qt_meta_stringdata_T_BasePage.data,
    qt_meta_data_T_BasePage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *T_BasePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_T_BasePage.stringdata0))
